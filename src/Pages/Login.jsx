...
const Login = () => {
  return (
    <div className="bg-[url('../src/Pages/img/sign.jpg')] bg-top bg-cover h-[80vh] w-full flex items-center justify-center pt-28">
      <div className="bg-black bg-opacity-50 w-full max-w-lg rounded-lg p-6 text-center text-white">
          <div>
            <h1 className="bg-red-600 px-4 py-1 rounded-full font-bold text-white">Log in</h1>
            <p className="text-2xl pt-6">Welcome Back! Please enter your details.</p>
          </div>
