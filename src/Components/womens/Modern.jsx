...
import modern from './modern/casual1.jpg'
import { Link } from 'react-router-dom';
const Modern = () => {
  return (
    <div>
      {/* Hero Section */}
      <div className="bg-cover bg-center w-full h-[50vh] sm:h-[500vh] lg:h-[75vh] xl:[75vh] bg-[url('../src/Components/womens/modern/cassualbg.webp')]">
