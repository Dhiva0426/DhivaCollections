...
import Wslipper1 from './footwear/sandalStrap.jpg'
...
const WomenFootwear = () => {
  return (
    <div>
      {/* Hero Section */}
      <div className="bg-cover bg-bottom w-full h-[50vh] sm:h-[500vh] lg:h-[75vh] xl:[75vh] bg-[url('../src/Components/womens/footwear/footwearbg.avif')]">
