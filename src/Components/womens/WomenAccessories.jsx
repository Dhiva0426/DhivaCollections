...
import handbag from './access/handbag.jpg'
...
const Chudi = () => {
  return (
    <div>
      {/* Hero Section */}
      <div className="bg-cover bg-top w-full h-[50vh] sm:h-[500vh] lg:h-[75vh] xl:[75vh] bg-[url('../src/Components/womens/access/accessbg.avif')]">
